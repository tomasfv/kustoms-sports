  ...
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${URL}profile/getcommemail?email=${email}`,
      )
      return dispatch({
...
export const getUserCarts = (email) => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${URL}profile/getclosecart?email=${email}`,
      )
      return dispatch({
...
export const getComments = (nameproduct, gender) => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${URL}getcomments?name=${nameproduct}&gender=${gender}`,
      )
      return dispatch({
...
export const getAllowed = (email, name, gender) => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `${URL}allowed?email=${email}&name=${name}&gender=${gender}`,
      )
      return dispatch({
...
export const dashComment = (id) => {
  return async function (dispatch) {
    try {
      ...
      return { type: types.DASH_POST, payload: json1.data }
    } catch (error) {
      //console.log(error);;
    }
  }
...
export const visitedcarrousel = (email) => {
  return async function (dispatch) {
    try {
      let userviews = await axios.get(
        `${URL}dashboard/carrouselview?email=${email}`,
      )
      return dispatch({
