...
function DashUserTable() {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    let nombreFinal = allUsers.filter((e) =>
  ...
  return (
    <div>
      <div className="text-xl mt-[50px] font-bold mb-4">Usuarios</div>
      <div className="m-4">
        <input
          type="text"
          placeholder="buscar..."
        ...
        />
        <button
          className="border font-bold pl-2 pr-2 ml-1"
          type="submit"
                  ...
                  <>
                    <tr className="text-l">
                      ...
                      <td className="border">
                        <img
                          src={f.picture}
                          className="w-[30px] h-[30px] rounded-full ml-[25%]"
                        />
                      </td>
                      ...
                      <td className="border hover:bg-gris-light">
                        <button
                          value={[f.email, f.available, f.id]}
                ...
                return (
                  <>
                    <tr className="text-l">
                      ...
                      <td className="border hover:bg-gris-light">
                        <button
                          value={[e.email, e.available, e.id]}
                          onClick={(e) => handleClick(e)}
                        >
