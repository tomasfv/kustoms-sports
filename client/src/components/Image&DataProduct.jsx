      ...
      <div className="flex flex-col gap-10 ">
        ...
        {details.promotion > 0 ? (
          <div className="flex flex-row">
            <p>Antes: </p>
            <div className=" flex ml-1 pl-0 line-through ">
              ${details.price}
            </div>
          </div>
        ) : (
        ...
        {details.promotion > 0 && (
          <div className=" flex ml-0 pl-0 text-verde-dark font-bold">
            {' '}
            Ahora: ${Math.round(details.price * (1 - details.promotion))}
          </div>
        )}
        ...
        {errors !== false && (
          <p className=" flex mt-0 text-[red]">Porfavor seleccione una talla</p>
        )}
        {isAuthenticated ? (
              ...
              <div className="  m-auto top-[700px]">
                <div className="flex  flex-row items-center justify-start flex-1 space-x-4 #f8fafc">
                  <span className="font-medium flex flex-row">
                    Agregar al Carrito{' '}
                    <BsFillCartPlusFill className="text-[20px] ml-[10px]" />
                  </span>
                </div>
              </div>
            </button>
