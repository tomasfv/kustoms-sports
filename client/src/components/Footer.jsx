    ...
    <footer className="flex flex-col bg-gris-light dark:bg-gris-dark min-h-[30.5rem]">
      <div className=" w-full flex flex-row justify-around text-main-dark dark:text-main-light p-20">
        ...
        <div className="flex flex-col">
          ...
          <a href="https://blog.soyhenry.com/" target="_blank" rel="noreferrer">
            Henry Blog
          </a>
          <a
            href="https://www.sportline.com.ar/"
            target="_blank"
            rel="noreferrer"
          >
            The Portal
        ...
        <div className="flex flex-col">
          <button
            hidden
            className="border rounded-md h-12 w-30 font-bold mb-2 p-2
                     dark:bg-verde-dark 
      ...
      <div className="w-full flex flex-row justify-around  text-main-dark dark:text-main-light">
        ...
        <div className="flex flex-row">
          ...
          <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer">
            <GrLinkedinOption className="h-5 w-5 mr-4" />
          </a>
          <a href="https://www.facebook.com/" target="_blank" rel="noreferrer">
            <BsFacebook className="h-5 w-5 mr-4" />
          </a>
