...
const stripePromise = loadStripe(
  'pk_test_51Lj7u9Dukzk6GqlmMVPMHwx3lemmPxbgy32HRrVczr7jnBiVC4MGYPQBzrrQz99uhWYB1KLstQ6PKDBJVDyROyXz00qQ34D93u',
)
...
const CheckoutForm = () => {
  ...
  return (
    <div className="">
      <form
        className="border rounded-md w-[450px] grid grid-col justify-items-center m-4 p-4 bg-gris-light"
      ...
      >
        ...
        <div className="rounded-lg">
          ...
          <button
            disabled={!stripe}
            className="font-bold rounded bg-verde-light text-main-light w-[420px] p-4"
          >
            {loading ? (
