...
const FormMod = ({ datos, color }) => {
  ...
  function validate(addproduct) {
    ...
    if (addproduct.name === '') {
      ...
      errors.name =
        'El nombre solo puede contener letras, números, espacios y barras'
    }
    ...
    if (addproduct.collection.length > 15) {
      errors.collection = 'Inserte un tipo de colección menor a 15 caracteres'
    }
    ...
    if (addproduct.promotion < 0 || addproduct.promotion > 100) {
      errors.promotion =
        'Solo se permiten porcentajes de descuento entre 0 y 100 '
    }
    return errors
  }
      ...
      <form>
        <div class="grid gap-6 mb-6 lg:grid-cols-2">
          ...
          <div>
            ...
            />
            {errors?.collection && (
              <p className="text-[15px] text-[red]">{errors.collection}</p>
            )}
          </div>
          <div>
            <label
          ...
          <div>
            ...
            />
            {errors?.clotheType && (
              <p className="text-[15px] text-[red]">{errors.clotheType}</p>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-row">
          ...
          <div className=" flex ml-[20px] mb-6 ">
            ...
            <input
              ...
              onChange={(e) => handleChange(e)}
              name="size"
              className="border-[1px] w-[70px] pl-2 text-s pr-2 rounded-sm ml-[5px] "
            />
          </div>
        </div>
      </form>
